					...
					foreach ($data_label->result() as $row):
						...
						<tr>
							...
							<td class="text-center">
								<a href="javascript:void(0);" title="Edit" data-id="<?=$row->id_label; ?>" data-label="<?=$row->nama_label; ?>" class="green edit-label">
									<i class="ace-icon fa fa-edit bigger-130"></i>
								</a>
								<a class="red tombol-hapus" href="<?=site_url('admin/berita/hapus-label/'.$row->id_label); ?>">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Label</h4>
			</div>
			<form method="post" action="<?=site_url('admin/berita/simpan_label')?>">
				<div class="modal-body">
					<div class="form-group">
						<label for="label">Nama Label</label>
						<input type="text" name="label" id="label" required placeholder="Nama Label" class="form-control" autofocus>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modalCategory" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" action="<?=site_url('admin/berita/update_label')?>">
				<div class="modal-body">
					<div class="form-group">
						<label for="label2">Nama Label</label>
						<input type="hidden" name="id_label">
						<input type="text" name="label2" id="label2" required autofocus placeholder="Nama Label" class="form-control">
					</div>
				</div>
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary"><i class="fa fa-fw fa-save"></i> Simpan</button>
...
<script type="text/javascript">
 ...
 $('.edit-label').on('click', function() {
 	...
 	$('[name="id_label"]').val(id);
 	$('[name="label2"]').val(name);
